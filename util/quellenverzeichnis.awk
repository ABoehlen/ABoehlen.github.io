...
#########################################################################################
#
# quellenverzeichnis.awk V1.3 31.08.2023
...
#
# Die Reihenfolge ist im verweise.js definiert und das dort verwendete Array muss
# ab Zeile 42 hier eingetragen werden.
#
...
ffIntrDict["ah"] = "5";
  ...
  ########################################################################
  # nachstehend oben definiertes Array eintragen, sodass eine Kopie 
  # unter dem einheitlichen Namen "verweise" angelegt wird
  ########################################################################
  for (i in ffIntrDict)
